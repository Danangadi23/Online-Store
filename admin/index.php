...
session_start();
// KONEKSI DATABASE
$koneksi = new mysqli("localhost", "root", "", "tokopenjualan");
  ...
  <div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top navbar-fixed-top" role="navigation" style="margin-bottom: 0;">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">TypoShop</a>
      </div>
      <div style="color: white; padding: 15px 50px 5px 50px;float: right;font-size: 16px;"> </div>
    </nav>
    <!-- /. NAV TOP  -->
    <nav class="navbar-default navbar-side" role="navigation" style="position:fixed; padding-top:50px;">
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          ...
          <li>
            ...
            <a href="index.php?halaman=produk"><i class="fa fa-bag-fill"></i> Produk</a>
        ...
        <?php
                ...
                if (isset($_GET['halaman'])) {
                    if ($_GET['halaman'] == "pelanggan") {
                        ...
                        include 'crud/tambah-produk.php';
                    } elseif ($_GET['halaman'] == "hapus-produk") {
                        include 'crud/hapus-produk.php';
                    } elseif ($_GET['halaman'] == "ubah-produk") {
                        include 'crud/ubah-produk.php';
                    } elseif ($_GET['halaman'] == "tambah-pelanggan") {
                        include 'crud/tambah-pelanggan.php';
                    } elseif ($_GET['halaman'] == "hapus-pelanggan") {
                        include 'crud/hapus-pelanggan.php';
                    } elseif ($_GET['halaman'] == "ubah-pelanggan") {
                        include 'crud/ubah-pelanggan.php';
