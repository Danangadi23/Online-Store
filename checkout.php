...
{
  echo "<script>alert('Terimakasih telah menambahkan')</script>";
}
else 
{
  echo "<script>alert('Belum berbelanja, Silahkan Berbelanja!!')</script>";
    ...
    <div class="container">
      ...
      <form action="" method="POST">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" name="alamat_pengiriman" id="alamat_pengiriman" placeholder="Masukkan alamat lengkap pengiriman (termasuk kode pos)" rows="5"></textarea>
        </div>
